...
import { FormHooks, nameCounter, NgModelOptions, trim } from '@app/shared/widgets/interfaces';
import { FormValidationScopeDirective, ValidationContext } from '@app/shared/validation';
