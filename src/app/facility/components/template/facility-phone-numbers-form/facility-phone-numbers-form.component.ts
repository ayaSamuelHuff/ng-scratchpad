...
// In this case, we lose the ability to do validation via the suites because the string object doesn't have any properties our ValidationSuite can map to.
// In a more real-world example, the phone numbers would be an array of objects with properties like "number" and "type" that we could map to a validation suite.
//
